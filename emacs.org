...
** Config file
   ...
   #+begin_src emacs-lisp
     ...
     (setq user-mail-address "wang1zhendire@hotmail.com")
...
** Miscellaneous configurations
   ...
   #+begin_src emacs-lisp
     ...
     ;; Auto-save behaviours from Doom
...
* Garbage Collection
  ...
  #+begin_src emacs-lisp
    (use-package gcmh
      ...
      (setq gcmh-high-cons-threshold (* 16 1024 1024)) ;; 16MB for GC
      (gcmh-mode))
  #+end_src
...
* Startup Benchmark
  ...
  #+begin_src emacs-lisp
    (defun w1/startup-benchmark ()
      "Showing Emacs initializing time, packages loaded and GC"
      (format "Emacs loaded %d packages in %.2f seconds with %d garbage collections."
	      (- (length load-path) (length (get 'load-path 'initial-value)))
	      (float-time (time-subtract (current-time) before-init-time))
	      gcs-done))

    (add-hook 'emacs-startup-hook (lambda ()
				    (setq init-message (w1/startup-benchmark))
...
** Org-download
   ...
   #+begin_src emacs-lisp
     (use-package org-download
       ...
       (defun w1/org-download-paste-clipboard (&optional use-default-filename)
	 (interactive "P")
	 (let ((file
...
** Xclip
   ...
   Xclip provides copy and paste in terminal mode.
   #+begin_src emacs-lisp
     (use-package xclip
       :ensure t
       :init (xclip-mode))
...
* Emacs-rime
  ...
  #+begin_src emacs-lisp
    ...
    ;; Windows下使用powertoys将Capslock键绑定为C-\实现快捷输入法切换
